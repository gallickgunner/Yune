...
{
    /** \brief This class manages the OpenCL context and Buffers.
     *
     */
    class CL_context
    {
        public:
             ...
             * \param[in] cl_ver        The OpenCL version for which to compile the file. The format should be as follows "-cl-std=CLx.y" where x.y represent the version (1.2, 2.0 etc)
             *
             */
            void createProgram(std::string file_name, std::string kernel_name, std::string cl_ver);
